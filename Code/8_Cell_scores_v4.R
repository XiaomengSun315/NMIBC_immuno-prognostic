# 2022.03.20. Revision version 2
# update with "6_Gene_Survival_v2.R".
# Use original clean data as input expression matrix to conduct ssGSEA & z-score analysis.
